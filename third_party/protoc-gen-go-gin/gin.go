...
const (
	...
	handlerPkg         = protogen.GoImportPath("github.com/xavierxcn/apiserver/internal/serve/handler")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by gitea.xavierx.cn/xavierxcn/apiserver/third_party/protoc-gen-go-gin. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the gitea.xavierx.cn/xavierxcn/apiserver/third_party/protoc-gen-go-gin package it is being compiled against.")
	g.P("// ", contextPkg.Ident(""), metadataPkg.Ident(""))
	g.P("// ", ginPkg.Ident(""), ginxPkg.Ident(""), handlerPkg.Ident(""))
	g.P()
